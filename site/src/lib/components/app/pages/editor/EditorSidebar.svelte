		...
		{#if hasLibrary}
			<div>
				...
				>
					...
					<div class="flex justify-between">
						<span>Processed</span>
						<span class="text-foreground font-medium">{stats.processedCount}</span>
					</div>
					<div class="flex justify-between">
				...
				<div class="mt-3 flex flex-col gap-1.5">
					<div class="flex items-center justify-between text-[10px] uppercase tracking-wider text-muted-foreground">
						...
						<span class="text-foreground font-medium">{verifiedPercent}%</span>
					</div>
					...
					<div class="text-[10px] uppercase tracking-wider text-muted-foreground">
						{stats.verifiedCount} of {totalFunctionCount} verified
					</div>
				</div>
			</div>
			<Separator />
							...
							<div class="flex items-center h-8 pr-1">
								...
								>
									...
									{:else if fnFlags.includes('verified')}
										<div
											class="mr-2 h-2 w-2 shrink-0 rounded-full bg-emerald-500"
